...
class UpdateProvinciaRequest extends FormRequest
{
    ...
    {
        return [
            'nombre' => 'required|unique:provincias,nombre,'. $this->id .',id,pais_id,' . $this->pais_id,
            'cod_provincia' => 'required|unique:provincias,cod_provincia,'. $this->id .',id,pais_id,' . $this->pais_id
        ];
    }
